...
public class CameraDialog extends DialogFragment {
	...
	private CameraDialogParent listener;
	 ...
	 * @return
	 */
	public static CameraDialog showDialog(final Activity parent/* add parameters here if you need */, CameraDialogParent cameraDialogParent) {
		CameraDialog dialog = newInstance(/* add parameters here if you need */);
		dialog.listener = cameraDialogParent;
		try {
	...
	public void onAttach(final Activity activity) {
       ...
       if (mUSBMonitor == null)
        try {
    		mUSBMonitor = listener.getUSBMonitor();
